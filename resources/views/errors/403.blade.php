  ...
  <div class="error-wrapper">
    <div class="container"><img class="img-100" src="{{asset('assets/images/other-images/sad.png')}}" alt="">
      ...
      <div class="col-md-8 offset-md-2">
        ...
        <p class="sub-content">{{ $exception->getMessage() ?: __('You do not have permission to access this resource.') }}</p></p>
      </div>
      <div><a class="btn btn-success-gradien btn-lg" href="{{route('dashboard')}}">{{__('BACK TO HOME PAGE')}}</a></div>
    </div>
  </div>
  <!-- error-403 end-->
</div>
