                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="blog-box blog-list row">
                                <div class="col-sm-5"><img class="img-fluid sm-100-w"
                                        src="{{ asset('assets/images/course/course-list-img-1.png') }}" alt="">
                                </div>
                                <div class="col-sm-7">
                                    <div class="blog-details">
                                        <h3 class="hd-30-bold">Chairside Assisting</h3>
                                        <h5 class="hd-14">Teacher Name</h5>
                                        <div class="border-b-grey"></div>
                                            <p class="md-grey">
                                                Lorem ipsum dolor sit amet consectetur. Feugiat tempor pulvinar suspendisse
                                                volutpat nullam venenatis integer hendrerit. Dapibus habitasse mattis aenean
                                                nulla. Odio cras mattis.
                                            </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-12">
                          <div class="card">
                              <div class="blog-box blog-list row">
                                  <div class="col-sm-5"><img class="img-fluid sm-100-w"
                                          src="{{ asset('assets/images/course/course-list-img-2.png') }}" alt="">
                                  </div>
                                  <div class="col-sm-7">
                                    <div class="blog-details">
                                        <h3 class="hd-30-bold">Chairside Assisting</h3>
                        ...
                        <div class="card">
                            <div class="blog-box blog-grid text-center product-box">
                                <div class="product-img"><img class="img-fluid top-radius-blog"
                                        src="{{ asset('assets/images/course/course-list-img-3.png') }}" alt="">
                    ...
                    <div class="col-xl-4 xl-50 col-sm-6 box-col-6">
                        <div class="card">
                            <div class="blog-box blog-grid text-center product-box">
                                <div class="product-img"><img class="img-fluid top-radius-blog"
                                        src="{{ asset('assets/images/course/course-list-img-4.png') }}" alt="">
                                    <div class="product-hover">
                                        <ul>
                                            <li><i class="icon-link"></i></li>
                                            <li><i class="icon-import"></i></li>
                    ...
                    <div class="col-xl-4 xl-50 col-sm-6 box-col-6">
                        <div class="card">
                            <div class="blog-box blog-grid text-center product-box">
                                <div class="product-img"><img class="img-fluid top-radius-blog"
                                        src="{{ asset('assets/images/course/course-list-img-5.png') }}" alt="">
                                    <div class="product-hover">
                                        <ul>
                                            <li><i class="icon-link"></i></li>
                                            <li><i class="icon-import"></i></li>
