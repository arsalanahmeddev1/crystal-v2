              ...
              <div class="tab-pane fade show active" id="chats" role="tabpanel" aria-labelledby="chats-tab">
                ...
                <ul class="chats-user">
                  ...
                  <li class="common-space active">
                    <div class="chat-time">
                      <div class="active-profile"><img class="img-fluid rounded-circle" src="../assets/images/dashboard-11/user/10.jpg" alt="user">
                        <div class="status bg-success"></div>
                      </div>
          ...
          <div class="right-sidebar-title">
            <div class="common-space"> 
              <div class="chat-time-chat">
                <div class="active-profile-chat"><img class="img-fluid rounded-circle" src="../assets/images/dashboard-11/user/10.jpg" alt="user">
                  <div class="status bg-success"></div>
                </div>
