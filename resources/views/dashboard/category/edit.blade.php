            ...
            <div class="col-sm-12">
                <div class="card height-equal">
                    ...
                    <div class="card-body custom-input">
                        <form class="row g-3" action="{{ route('dashboard.category.update', $category->id) }}" method="POST"
                            ...
                            <div class="col-12">
                                ...
                                <input class="form-control @error('name') is-invalid @enderror" id="name"
                                    type="text" placeholder="Enter Name" name="name" value="{{ $category->name ?? old('name') }}"
